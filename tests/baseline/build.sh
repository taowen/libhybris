...
cp shaders/packed.vert shaders/packed.inc shaders/generate-packed.py shaders/point-size.vert shaders/point-size.frag shaders/point-size.inc shaders/generate-point-size.py shaders/scaled.builtins.inc shaders/generate-unused-builtins.py shaders/widget-multi.vert shaders/widget-multi.frag shaders/widget-multi.vert.inc shaders/widget-multi.frag.inc shaders/generate-widget-multi.py shaders/bc-sample.comp shaders/bc-sample.inc shaders/generate-bc-sample.py shaders/scaled.divisor.vert shaders/scaled.divisor.inc shaders/group_decorations.py shaders/scaled.group.inc shaders/scaled.group-multi.inc shaders/scaled.group-spec.inc shaders/scaled.spec-direct.inc shaders/scaled.spec.vert shaders/scaled.spec.inc shaders/scaled.aggregate.vert shaders/scaled.matrix.inc shaders/scaled.array.inc shaders/scaled.nested.inc shaders/scaled.matarray.inc shaders/scaled.literal.inc shaders/generate-scaled.py shaders/scaled.multi.inc shaders/scaled.vert shaders/scaled.frag shaders/scaled.vert.inc shaders/scaled.frag.inc shaders/widget.vert shaders/widget.frag shaders/widget.vert.inc shaders/widget.frag.inc shaders/widget-large.vert.inc shaders/widget-large.frag.inc "$PROBE_SRC/shaders/"
