...
cp shaders/scaled.aggregate.vert shaders/scaled.matrix.inc shaders/scaled.array.inc shaders/scaled.nested.inc shaders/scaled.matarray.inc shaders/scaled.literal.inc shaders/generate-scaled.py shaders/scaled.multi.inc shaders/scaled.vert shaders/scaled.frag shaders/scaled.vert.inc shaders/scaled.frag.inc shaders/widget.vert shaders/widget.frag shaders/widget.vert.inc shaders/widget.frag.inc shaders/widget-large.vert.inc shaders/widget-large.frag.inc "$PROBE_SRC/shaders/"
