...
OUT="${OUT:-$PWD/build}"
BUNDLE="$OUT/bundle"
SOURCES=(probe_timeline.c render_path.c probe_render_owners.c probe.c probe_stdio.c probe_common.c probe_egl.c probe_egl_lifecycle.c probe_vulkan.c probe_dispatch.c
