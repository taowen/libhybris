...
if a.icd_hal:
    ...
    cases += [('icd', mode, 'probe-glibc')
              for mode in ('vk', 'vk-dlsym', 'vk-gdpa', 'vk-core11', 'vk-khr11', 'dispatch', 'life', 'vk-init', 'vk-alloc', 'icd-alloc-direct', 'unload', 'tls', 'caps', 'caps2', 'ubo', 'ubo-dynamic')]
    ...
    if a.validation_layer:
        ...
        cases.extend([('icd', mode, 'probe-glibc') for mode in ('validation', 'ubo-validation', 'ubo-dynamic-validation')])
