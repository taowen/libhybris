...
int main(int argc, char **argv) {
    ...
    if (argc != 2 || (strcmp(argv[1], "control") && strcmp(argv[1], "present") && strcmp(argv[1], "missing-protocol") && strcmp(argv[1], "acquire-timeout") && strcmp(argv[1], "resize") && strcmp(argv[1], "surface-lost") && strcmp(argv[1], "fence-acquire"))) return 2;
    ...
    if (!strcmp(argv[1], "fence-acquire")) setenv("HYBRIS_X11_FENCE_ACQUIRE", "1", 1);
