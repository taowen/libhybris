...
int x11_surface_change(PFN_vkGetInstanceProcAddr, VkInstance, VkPhysicalDevice, VkDevice, VkQueue,
    xcb_connection_t *, xcb_window_t *, VkSwapchainCreateInfoKHR *, VkSwapchainKHR *,
    VkCommandBuffer, VkFence, const VkSemaphore *, unsigned, unsigned, unsigned, int);
